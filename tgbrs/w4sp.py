...
def getip():
    P2X = "None"
    try:
        P2X = urlopen(Request("https://api.ipify.org")).read().decode().strip()
    except:
        pass
    return P2X
